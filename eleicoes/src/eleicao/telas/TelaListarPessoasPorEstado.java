...
public class TelaListarPessoasPorEstado extends javax.swing.JFrame {
    ConnectionFactory conexao = new ConnectionFactory();
    EstadoDAO estadoDAO = new EstadoDAO();
 
    public TelaListarPessoasPorEstado() {
        initComponents();
        preenchercombo();
        //invisivel();
        preencher();
    ...
    private void preencher(){
        ...
        tarefa = new TimerTask() {
            public void run() {
                ...
                ResultSet rs;
                try {
                    rs = pessoasDAO.BuscarPessoaPorEstado(jComboBoxEstado.getSelectedItem().toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaListarPessoasPorEstado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
