...
public class TelaListarTodosCandidatos extends javax.swing.JFrame {
        ConnectionFactory conexao = new ConnectionFactory();
        CandidatoDAO candidatoDAO = new CandidatoDAO();
  
    public TelaListarTodosCandidatos() {
        initComponents();
        preencher();
    }
    private void preencher(){
        ...
        tarefa = new TimerTask() {
            public void run() {
                ...
                ResultSet rs = null;
                try {
                    rs = candidatoDAO.BuscarTodosCandidatos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaListarTodosCandidatos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
