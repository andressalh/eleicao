...
public class TelaListarCandidatosPorCidade extends javax.swing.JFrame {
        ConnectionFactory conexao = new ConnectionFactory();
        EstadoDAO estadoDAO = new EstadoDAO();
        CidadeDAO cidadeDAO = new CidadeDAO();
        CandidatoDAO candidatoDAO = new CandidatoDAO();

    public TelaListarCandidatosPorCidade() {
        initComponents();
        preenchercombo();
        preencher();
    }
     ...
     private void preencher(){
        ...
        tarefa = new TimerTask() {
            public void run() {
                ...
                ResultSet rs;
                try {
                    rs = candidatoDAO.BuscarCandidatosPorCidade(jComboBoxCidade.getSelectedItem().toString());
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jScrollPane2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 1082, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaListarCandidatosPorCidade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
