...
public class TelaListarCandidatosPorRegiao extends javax.swing.JFrame {
     ConnectionFactory conexao = new ConnectionFactory();
        EstadoDAO estadoDAO = new EstadoDAO();
        PessoasDAO pessoasDAO = new PessoasDAO();
    
    public TelaListarCandidatosPorRegiao() {
        initComponents();
        preenchercombo();
        preencher();
    }
    ...
    private void preencher(){
        ...
        tarefa = new TimerTask() {
            public void run() {
                ...
                ResultSet rs;
                try {
                    rs = estadoDAO.BuscarCandidatosPorRegiao(jComboBoxRegiao.getSelectedItem().toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaListarCandidatosPorRegiao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
